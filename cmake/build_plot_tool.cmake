function(build_plot_tool PLOT_TOOL_NAME)
  ...
  #Aggregate plot tool source files
  ...
  target_include_directories(${PLOT_TOOL_NAME} SYSTEM PRIVATE ${CMAKE_SOURCE_DIR}/submods/amrex/Src/Base)
  target_include_directories(${PLOT_TOOL_NAME} SYSTEM PRIVATE ${CMAKE_SOURCE_DIR}/submods/amrex/Tools/Plotfile)
