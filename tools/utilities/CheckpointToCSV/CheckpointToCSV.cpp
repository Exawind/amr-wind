...
void main_main()
{
    ...
    amrex::Print() << "Converting checkpoint file " << checkpointfile
                   << " to format " << format_str << std::endl;
    // Help information

    // Load Checkpoint File
    time_req = clock();
    CheckpointFileDataImpl chkptfile(
        checkpointfile, addl_fnames); // Takes care of invalid files
