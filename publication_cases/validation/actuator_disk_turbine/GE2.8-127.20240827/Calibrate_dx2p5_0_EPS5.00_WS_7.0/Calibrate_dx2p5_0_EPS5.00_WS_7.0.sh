...
mpiexec --bind-to core --npernode $cores --n $ncpus /projects/wind_uq/lcheung/AMRWindBuilds/hfm.20240102/amr-wind/build/amr_wind Calibrate_dx2p5_0_EPS5.00_WS_7.0.inp
