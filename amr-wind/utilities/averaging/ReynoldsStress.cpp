...

{
    ...
    m_re_stress.fillpatch_on_regrid() = true;
                ...
                bx, [=] AMREX_GPU_DEVICE(int i, int j, int k) noexcept {
                    ...
                    for (int n = 0; n < ncomp; ++n) {
                        for (int m = n; m < ncomp; ++m) {
                            ...
                            // AB
                            const amrex::Real fval2 = fldarr(i, j, k, m) * fldarr(i, j, k, n);
                            // <A><B>
                            const amrex::Real aval2 = avgarr(i, j, k, m) * avgarr(i, j, k, n);
                            // The current value
                            ...
                            restressarr(i, j, k, mn) = stressarr(i, j, k, mn) - aval2;
