...
#include "amr-wind/physics/ScalarAdvectionFieldInit.H"
#include "AMReX_Gpu.H"
#include "AMReX_ParmParse.H"

namespace amr_wind {

ScalarAdvectionFieldInit::ScalarAdvectionFieldInit()
{
    amrex::ParmParse pp_boussinesq_bubble("ScalarAdvection");
...
void ScalarAdvectionFieldInit::operator()(
    const amrex::Box& vbx,
