    ...
    const amrex::Real uy1r)
{
    ...
    const amrex::Real tau_xz = (1.0_rt / static_cast<amrex::Real>(M_PI)) *
                               ur_mag * ur_mag * grad_eta_wave * grad_eta_wave *
                               Heavi * n_x;
    const amrex::Real tau_yz = (1.0_rt / static_cast<amrex::Real>(M_PI)) *
                               ur_mag * ur_mag * grad_eta_wave * grad_eta_wave *
                               Heavi * n_y;
