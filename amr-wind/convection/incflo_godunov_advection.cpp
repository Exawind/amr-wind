...
void
godunov::compute_advection(int lev, Box const& bx, int ncomp,
                           ...
                           godunov::scheme godunov_scheme)
{
    ...
    switch(godunov_scheme)
    {
        ...
        case godunov::scheme::PPM_NOLIM:
        {
            ...
            [=] AMREX_GPU_DEVICE (int i, int j, int k, int n) noexcept
            {
                Godunov_ppm_fpu_x_nolim(i, j, k, n, l_dt, dx, Imx(i,j,k,n), Ipx(i,j,k,n),
                                        q, umac, pbc[n], dlo.x, dhi.x);
                Godunov_ppm_fpu_y_nolim(i, j, k, n, l_dt, dy, Imy(i,j,k,n), Ipy(i,j,k,n),
                                        q, vmac, pbc[n], dlo.y, dhi.y);
                Godunov_ppm_fpu_z_nolim(i, j, k, n, l_dt, dz, Imz(i,j,k,n), Ipz(i,j,k,n),
                                        q, wmac, pbc[n], dlo.z, dhi.z);
            });
        break;
        }
        case godunov::scheme::WENO:
        {
            ...
            [=] AMREX_GPU_DEVICE (int i, int j, int k, int n) noexcept
            {
                Godunov_weno_fpu_x(i, j, k, n, l_dt, dx, Imx(i,j,k,n), Ipx(i,j,k,n),
                                  q, umac, pbc[n], dlo.x, dhi.x);
                Godunov_weno_fpu_y(i, j, k, n, l_dt, dy, Imy(i,j,k,n), Ipy(i,j,k,n),
                                        q, vmac, pbc[n], dlo.y, dhi.y);
                Godunov_weno_fpu_z(i, j, k, n, l_dt, dz, Imz(i,j,k,n), Ipz(i,j,k,n),
                                        q, wmac, pbc[n], dlo.z, dhi.z);
