...
void ABL::pre_advance_work()
{
    ...
    if (m_abl_forcing != nullptr) {
        ...
        //     m_sim.helics().m_inflow_wind_direction_to_amrwind + 270.0 ; 	const
        //     amrex::Real wind_direction_radian =
        //     amr_wind::utils::radians(wind_direction); 	const amrex::Real tvx =
        //     wind_speed * std::cos(wind_direction_radian); 	const amrex::Real
        //     tvy = wind_speed * std::sin(wind_direction_radian);
