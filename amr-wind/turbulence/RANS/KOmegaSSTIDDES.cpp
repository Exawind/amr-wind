            ...
            amrex::ParallelFor(
                bx, [=] AMREX_GPU_DEVICE(int i, int j, int k) noexcept {
                    ...
                    const amrex::Real l_les =
                        cdes *
                        std::min(Cw * std::max(wd_arr(i, j, k), hmax), hmax);
