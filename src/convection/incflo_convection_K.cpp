                                    ...
                                    Array4<Real> const& w, Array4<Real const> const& vcc)
{
    ...
    bool extdir_ilo = (bc_ilo == BC::mass_inflow) or (bc_ilo == BC::no_slip_wall) or (bc_ilo == BC::wall_model);
    bool extdir_ihi = (bc_ihi == BC::mass_inflow) or (bc_ihi == BC::no_slip_wall) or (bc_ilo == BC::wall_model);
    bool extdir_jlo = (bc_jlo == BC::mass_inflow) or (bc_jlo == BC::no_slip_wall) or (bc_ilo == BC::wall_model);
    bool extdir_jhi = (bc_jhi == BC::mass_inflow) or (bc_jhi == BC::no_slip_wall) or (bc_ilo == BC::wall_model);
    bool extdir_klo = (bc_klo == BC::mass_inflow) or (bc_klo == BC::no_slip_wall) or (bc_ilo == BC::wall_model);
    bool extdir_khi = (bc_khi == BC::mass_inflow) or (bc_khi == BC::no_slip_wall) or (bc_ilo == BC::wall_model);
