...
contains
   ...
   subroutine compute_bcoeff_mac ( lo, hi, bcoeff, alo, ahi, &
        u_i, ulo, uhi, ro_g, slo, shi, dir )  bind(C)
   ...
   !
   ! Compute the cell-centered divergence of {u_g,v_g,w_g}
   ! 
   subroutine compute_mac_diveu ( lo, hi, diveu, slo, shi, u_g, ulo, uhi, &
   ...
   ! Compute the cell-centered divergence of {u_g,v_g,w_g}
   ! 
   subroutine compute_mac_diveu_eb ( lo, hi, diveu, slo, shi, u_g, ulo, uhi, &
