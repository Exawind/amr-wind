...
.. input_param:: incflo.physics
   ...
   **type:** List of strings
   ...
   For immersed boundary forcing method, :ref:`TerrainDrag <inputs_terraindrag>`, :ref:`ImmersedTerrain <inputs_immersedterrain>` (partial terrain fraction) or :ref:`ChannelBuilder <inputs_channel_builder>` can be used.
