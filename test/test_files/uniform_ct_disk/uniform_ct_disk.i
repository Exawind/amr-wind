...
Actuator.UniformCtDisk.yaw = 45.0 # degrees (yaw is relative to north which defaults to {0,1,0})
Actuator.UniformCtDisk.sample_yaw = 90.0 # set velocity sampling to be in the normal flow direction
